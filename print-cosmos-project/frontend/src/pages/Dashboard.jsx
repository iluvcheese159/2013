...
import { Plus, Package, Eye, DollarSign, ShoppingBag, Trash2 } from "lucide-react";
...
export default function Dashboard() {
  ...
  const deleteListing = async (listing) => {
    if (typeof window !== "undefined") {
      const ok = window.confirm(`Delete "${listing.title}"? This will archive the listing and remove it from the marketplace.`);
      if (!ok) return;
    }
    try {
      await api.delete(`/seller/listings/${listing.listing_id}`);
      await refreshListings();
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      data-testid={`delete-listing-btn-${l.listing_id}`}
