...
const PERKS = [
  ...
  { icon: MessageSquare, title: "Priority replies", body: "Your DMs are free for everyone. Pro boosts your replies to the top of buyers' inboxes." },
  { icon: Hammer, title: "Pro designer toolkit", body: "Pro shapes, snap-to-grid, multi-select coming soon." },
  { icon: Sparkles, title: "Pro badge on your profile", body: "Stand out in search, listings, and DMs." },
];
    ...
    return (
      <div data-testid="pro-success" className="pt-20 px-6 pb-16 text-center min-h-screen">
        ...
        <p className="text-sm text-muted-foreground mb-8 max-w-md mx-auto">
          Your fee just dropped to 2%, the Pro badge is on your profile, and Pro priority replies are active.
        </p>
        <div className="mb-8">
    ...
    <div data-testid="pro-page" className="pt-20 min-h-screen">
      <div className="px-6 md:px-12 py-16 max-w-5xl">
        ...
        <h1 className="font-display text-5xl sm:text-7xl font-light tracking-tighter mb-6">
          Print Cosmos <span className="text-accent font-medium">Pro</span>
        </h1>
        <p className="text-base text-muted-foreground max-w-xl leading-relaxed mb-4">
          Drop your platform fee to 2%, get a Print Cosmos badge across the platform, and unlock the Pro
        ...
        {user?.is_pro ? (
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-accent/10 border border-accent/30 text-accent rounded-xl text-xs font-tech uppercase tracking-wider">
            <Check className="h-3.5 w-3.5" /> You're already Pro
          </div>
        ) : (
          <Button
