...
import { Package, ExternalLink, Truck, ShoppingBag, Clock, ChevronRight } from "lucide-react";
  ...
  if (!user) {
    return (
      <div className="pt-32 px-6 md:px-12 lg:px-24 text-center">
        <ShoppingBag className="h-16 w-16 mx-auto mb-6 text-muted-foreground" strokeWidth={1} />
