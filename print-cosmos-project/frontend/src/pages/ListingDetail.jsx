...
import { Share2, Download, ArrowLeft, MessageSquare, FileBox, Info, GitFork, Lock, Trash2, Box, Flag, ChevronLeft, ChevronRight, Star, Heart, ShoppingCart, Reply, Forward, SmilePlus, UserPlus, UserCheck } from "lucide-react";
...
export default function ListingDetail() {
  ...
  return (
    <div data-testid="listing-detail-page" className="pt-14 min-h-screen relative bg-black">
      ...
      <StarfieldRenderer starCount={150} seed={Date.now()} className="fixed inset-0 opacity-30" />
      ...
      <div className="px-6 md:px-12 lg:px-24 py-10 grid lg:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-3 text-[11px] font-tech">
          ...
          <div className="flex items-center gap-2 text-xs font-tech uppercase tracking-[0.2em] text-muted-foreground mb-3 flex-wrap">
            ...
            <UserBadges isPro={item.seller_is_pro} isPlatformOwner={item.seller_is_platform_owner} milestoneBadges={item.seller_milestone_badges} />
            <span>·</span>
              ...
              <li key={c.comment_id} data-testid={`comment-${c.comment_id}`} className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="font-display text-sm font-medium inline-flex items-center gap-1">{c.user_name} <UserBadges isPro={c.user_is_pro} isPlatformOwner={c.user_is_platform_owner} milestoneBadges={c.user_milestone_badges} /></span>
