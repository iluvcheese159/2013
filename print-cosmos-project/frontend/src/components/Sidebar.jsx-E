...
import { Home, Hammer, Search, MessageSquare, ShoppingCart, Sparkles, PanelLeftClose, PanelLeftOpen, Tag, Rocket, BarChart3, ShieldAlert } from "lucide-react";
...
const NAV = [
  ...
  { to: "/forums", icon: Rocket, label: "Forums", testid: "side-forums" },
