...
export default function Wishlists() {
  ...
  const renderCard = (w, showOwner = false) => (
    <div key={w.wishlist_id} className="border border-border rounded-2xl p-5 bg-card hover:border-primary/50 transition-colors">
      <div className="flex items-start justify-between gap-3 mb-2">
        <div>
          <h3 className="font-display text-lg font-medium leading-tight">{w.title}</h3>
  ...
  return (
    <div data-testid="wishlists-page" className="pt-14 min-h-screen">
      <div className="border-b border-border px-6 md:px-12 lg:px-24 py-10">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <h1 className="font-display text-4xl sm:text-5xl font-light tracking-tighter">I wish someone made this.</h1>
      ...
      <div className="px-6 md:px-12 lg:px-24 py-10 space-y-10">
        {user && (
          <section>
            <h2 className="font-display text-xl font-medium mb-4">Your wishes</h2>
            {wishlists.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {wishlists.map((w) => renderCard(w, false))}
              </div>
            )}
          </section>
        )}
        ...
        <section>
          <h2 className="font-display text-xl font-medium mb-4">Community wishes</h2>
