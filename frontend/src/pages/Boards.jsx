      ...
      <div className="border-b border-border px-6 md:px-12 lg:px-24 py-10">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <h1 className="font-display text-4xl sm:text-5xl font-light tracking-tighter">Work together.</h1>
      ...
      <div className="px-6 md:px-12 lg:px-24 py-10 space-y-10">
          ...
          <section>
            ...
            {myBoards.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {myBoards.map((b) => Card({ col: b, showOwner: false }))}
              </div>
            )}
          </section>
        )}
        ...
        <section>
          ...
          {publicBoards.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {publicBoards.map((b) => Card({ col: b, showOwner: true }))}
            </div>
          )}
        </section>
      </div>
