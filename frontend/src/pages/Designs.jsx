    ...
    <div data-testid="designs-page" className="pt-14 min-h-screen">
      <div className="border-b border-border px-6 md:px-12 lg:px-24 py-10">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
          <h1 className="font-display text-4xl sm:text-5xl font-light tracking-tighter rise-in rise-in-1">Open designs.</h1>
          ...
          <div className="relative w-full max-w-sm rise-in rise-in-3 auto-glow-pulse">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filtered.map((d) => (
              <Link
                ...
                style={{ animationDelay: `${(d.design_id || 0) % 6 * 0.12}s` }}
              >
